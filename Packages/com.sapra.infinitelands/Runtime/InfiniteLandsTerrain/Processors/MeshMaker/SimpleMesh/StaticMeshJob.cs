...
namespace sapra.InfiniteLands.MeshProcess
{
    ...
    internal struct StaticMeshJob : IJobFor
    {
        ...
        public static JobHandle ScheduleParallel(UnityEngine.Mesh.MeshData meshData, MeshSettings meshSettings, WorldFinalData worldFinalData, Bounds objectSpaceBounds)
        {
            ...
            var job = new StaticMeshJob
            {
                ...
                OriginalPositions = worldFinalData.FinalPositions,
                vertex = vertex,
                triangles = triangles,
            };
