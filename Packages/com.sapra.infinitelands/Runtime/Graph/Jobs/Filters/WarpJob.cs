...
namespace sapra.InfiniteLands{    
    ...
    public struct WarpPointsJob : IJobFor
    {
        ...
        public void Execute(int i)
        {
            ...
            float warpValueX = globalMapX[warpXIndex + warpX.IndexOffset];
            warpValueX = warpValueX * 2f - 1f;

            int warpYIndex = MapTools.RemapIndex(i, targetResolution, warpY.Resolution);
            float warpValueY = globalMapY[warpYIndex+warpY.IndexOffset];
        ...
        public static JobHandle ScheduleParallel(NativeArray<float3> originalPoints, NativeArray<float3> targetPoints,
            ...
            int targetResolution, int parentResolution, JobHandle dependency) => new WarpPointsJob()
        {
    ...
    public struct WarpPointsMaskedJob : IJobFor
    {
        ...
        public void Execute(int i)
        {
            ...
            float maskValue = globalMapX[maskIndex+mask.IndexOffset];
        ...
        public static JobHandle ScheduleParallel(NativeArray<float3> originalPoints, NativeArray<float3> targetPoints,
            ...
            int targetResolution, int parentResolution,  JobHandle dependency) => new WarpPointsMaskedJob()
        {
            originalPoints = originalPoints,
            globalMapX = globalMapX,
            globalMapY = globalMapY,
    ...
    public struct WarpPointsNormalMapJob : IJobFor
    {
        ...
        public static JobHandle ScheduleParallel(NativeArray<float3> originalPoints, NativeArray<float3> targetPoints,
            ...
            int targetResolution, int parentResolution, JobHandle dependency) => new WarpPointsNormalMapJob()
        {
            strength = strength,
            originalPoints = originalPoints,
            normalMap = normalMap,
    ...
    public struct WarpPointsNormalMaskedJob : IJobFor
    {
        ...
        public static JobHandle ScheduleParallel(NativeArray<float3> originalPoints, NativeArray<float3> targetPoints,
            ...
            int targetResolution, int parentResolution, JobHandle dependency) => new WarpPointsNormalMaskedJob()
        {
            strength = strength,
            originalPoints = originalPoints,
            globalMapX = globalMapX,
