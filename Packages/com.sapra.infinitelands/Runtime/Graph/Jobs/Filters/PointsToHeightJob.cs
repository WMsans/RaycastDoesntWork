...
namespace sapra.InfiniteLands{
    ...
    public struct PointsToHeightJob : IJobFor
    {
        ...
        public void Execute(int i)
        {
            ...
            heightMap[target.IndexOffset + i] = math.saturate(totalWeight);
        }
        ...
        public static JobHandle ScheduleParallel(NativeArray<float> globalMap, NativeArray<float3> vertices, NativeArray<PointTransform> points,
            IndexAndResolution target,
            int PointsCount, int VerticesResolution, float Strength, float Distance, 
    ...
    public struct PointsToHeightTextureJob : IJobFor
    {
        ...
        public void Execute(int i)
        {
            ...
            heightMap[target.IndexOffset + i] = totalWeight;//math.saturate(totalWeight);
        }
