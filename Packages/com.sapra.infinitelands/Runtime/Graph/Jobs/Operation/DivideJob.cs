...
namespace sapra.InfiniteLands
{
    ...
    public struct DivideJob : IJobFor
    {
        ...
        public void Execute(int i)
        {
            ...
            float valueDividend = heightMap[dividend.IndexOffset + indexDividend];
            float valueDivisor = heightMap[divisor.IndexOffset + indexDivisor];
                        heightMap[target.IndexOffset + i] = valueDivisor != 0 ? valueDividend/valueDivisor : 0;
        }
