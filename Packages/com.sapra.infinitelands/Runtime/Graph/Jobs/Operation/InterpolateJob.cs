...
namespace sapra.InfiniteLands
{
    ...
    public struct InterpolateJob : IJobFor
    {
        ...
        public void Execute(int i)
        {
            ...
            float value0 = heightMap[height0.IndexOffset + index0];
            float value1 = heightMap[height1.IndexOffset + inde1];
            float maskValue = JobExtensions.invLerp(MaskMinMax.x, MaskMinMax.y, heightMap[mask.IndexOffset + indexMask]);
            heightMap[target.IndexOffset + i] = lerp(value0, value1, maskValue);
        }
