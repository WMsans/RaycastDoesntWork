...
namespace sapra.InfiniteLands
{
    ...
    public class PlacePrefabNode : InfiniteLandsNode, ILoadPoints, IProcessPoints
    {
        ...
        {
            return ProcessDependency(branch, nameof(Positions));
        }

        protected override void SetInputValues(BranchData branch)
        {
            TryGetInputData(branch, out Positions, nameof(Positions));
        }
        ...
        protected override void Process(BranchData branch)
        {
            ...
            Output = manager.GetPointInstance(this, gridBranch.GridCreator, Positions.GridSize, Positions, branch.meshSettings.Seed, true);
        }
