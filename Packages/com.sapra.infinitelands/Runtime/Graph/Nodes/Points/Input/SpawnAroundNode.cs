...
namespace sapra.InfiniteLands
{
    ...
    public class SpawnAroundNode : InfiniteLandsNode, IProcessPoints
    {
        ...
        {
            TryGetInputData(branch, out Origins, nameof(Origins));
        }
        ...
        protected override void Process(BranchData branch)
        {
            ...
            Output = manager.GetPointInstance(this, gridBranch.GridCreator, Origins.GridSize, Origins, branch.meshSettings.Seed);
        }
