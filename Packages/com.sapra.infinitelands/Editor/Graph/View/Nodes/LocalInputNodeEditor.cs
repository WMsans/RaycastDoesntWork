...
namespace sapra.InfiniteLands.Editor{
    ...
    public class LocalInputNodeEditor : NodeView
    {
        ...
        public LocalInputNodeEditor(TerrainGeneratorView view, InfiniteLandsNode node) : base(view, node){}
        ...
        void CreateMenu(EdgeConnection currentConnection)
        {
            ...
            foreach (LocalOutputNode newNode in asset)
            {
                ...
                if(outputEdge != null){
                    ...
                    tp = outputNode.GetType().GetField(outputEdge.outputPort.fieldName).FieldType;
                }
