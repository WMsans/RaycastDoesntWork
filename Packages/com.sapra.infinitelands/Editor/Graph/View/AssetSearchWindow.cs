...
namespace sapra.InfiniteLands.Editor
{
    public class AssetSearchWindow : EditorWindow
    {
        ...
        public void Initialize(Action<UnityEngine.Object> onSelectObjectCallback, UnityEngine.Object preselected, Type filter = null, Type avoid = null, bool allowEmpty = true)
        {
            ...
            // Load the UXML
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/com.sapra.infinitelands/Editor/UIBuilder/AssetSearchWindow.uxml");
            visualTree.CloneTree(rootVisualElement);

            // Load the USS
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Packages/com.sapra.infinitelands/Editor/UIBuilder/AssetSearchWindow.uss");
