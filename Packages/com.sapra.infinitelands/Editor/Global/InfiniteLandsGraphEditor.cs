    ...
    public class InfiniteLandsGraphEditor : EditorWindow, IHasCustomMenu
    {
        ...
        void SettingsWindow(){
            ...
            if(treeInstance != null){
                ...
                AutoUpdateToggle.TrackPropertyValue(property, a => treeInstance.NotifyValuesChanged());
        ...
        public void UpdateTextures(){
            if(treeInstance != null){
                ...
                var targetPreviews = treeView.ElementsByGuid.Values.OfType<NodeView>().Select(a => a.ActivePreview).Where(a => a != null);
        ...
        private void Regenerate(){
            ...
            var visualizers = FindObjectsByType<InfiniteLandsTerrain>(FindObjectsSortMode.None);
        ...
        private void UpdateUI(bool synchornize)
        {
            ...
            settings.EditorGUID = GetInstanceID().ToString();
